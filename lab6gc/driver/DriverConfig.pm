...
our $GCC_TIMEOUT        = 10;    # timeout for GCC on asm file
our $RUN_TIMEOUT        = 8;    # timeout for running compiled executable
...
my $MAX_SCORE1 = 30;        # maximal score for compiler, test suite 1
my $MAX_SCORE2 = 20;        # maximal score for compiler, test suite 2
